...
const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "حساب پراپ (از ۱,۰۰۰ تا ۵۰,۰۰۰ دلاری) را با MOON فعال می‌کنید و در ۳۰ روز باید هدف پوینتی را بدون عبور از حد افت و سقف ضرر روزانه بزنید. پاداش هر چلنج، حساب پراپی به اندازه‌ی همان تیر است. حساب‌های ۱۰۰ تا ۱,۰۰۰ دلاری هم جوایز اکسترای کمپین‌های دوره‌ای‌اند.",
      },
      {
        q: "شرکت در آرنا هزینه دارد؟",
        a: "خیر — هر روز ۵ پیش‌بینی رایگان دارید. پیش‌بینی‌های بیشتر هر کدام ۱ MOON هزینه دارند و ورود به چلنج پراپ نیز با MOON انجام می‌شود. MOON هیچ تأثیری بر امتیاز و نتیجه ندارد؛ فقط ظرفیت باز می‌کند.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "بازی رایگان است؟",
        a: "بله — تایم‌فریم ۲۴ ساعته رایگان است (تا ۲ بار در روز) و هنگام ثبت‌نام ۱۰ MOON هدیه می‌گیرید. تایم‌فریم‌های ۱۲، ۴ و ۱ ساعته با MOON باز می‌شوند.",
      },
      {
        q: "MOON چیست و چطور بخرم؟",
        a: "MOON فقط قابلیت باز می‌کند (تایم‌فریم کوتاه‌تر و پیش‌بینی بیشتر) و روی امتیاز و رتبه اثری ندارد. بسته‌ها از ۵۰ MOON (۵ تتر) تا ۱۰۰۰ MOON (۵۰ تتر) هستند و پرداخت با USDT از طریق پشتیبانی انجام می‌شود.",
      },
      {
