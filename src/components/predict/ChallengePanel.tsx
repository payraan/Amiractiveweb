        ...
        <div className="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1.5 text-[11px] leading-6 text-muted">
              ...
              و قابل برداشت‌اند، اما دوره‌ای، پس از بررسی انسانی، و تا{" "}
              <b className="text-gold">سقف ماهانه‌ی</b> همان تیر — که روی کارت هر
              تیر نوشته شده است. سود بیش از سقف قابل برداشت نیست و به ماه بعد
              منتقل نمی‌شود.
            </p>
          </div>
        </div>
