...
const ERRORS: Record<string, string> = {
  ...
  telegram_account: "این حساب با تلگرام ساخته شده و رمز عبور ندارد. از ربات تلگرام وارد شوید.",
  ...
  insufficient_credits: "MOON کافی ندارید. برای تایم‌فریم‌های کوتاه‌تر MOON لازم است.",
