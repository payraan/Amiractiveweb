...
const STEPS = [
  {
    n: "۱",
    t: "چالش را انتخاب می‌کنید",
    d: "با MOON وارد آن می‌شوید. اندازه‌ی حساب را خودتان انتخاب می‌کنید؛ از کوچک شروع کنید.",
  },
  {
    n: "۲",
    t: "همان کار همیشگی را می‌کنید",
    d: "لازم نیست جای جدیدی بروید. همان پیش‌بینی‌هایی که در ترید ثبت می‌کنید، در ارزیابی چالش هم شمرده می‌شوند.",
  },
  {
    n: "۳",
    t: "۳۰ روز فرصت داری",
    d: "باید به هدف امتیاز برسید، بدون اینکه از سقف افت رد شوی و بدون اینکه سود شما روی یک روز شانسی جمع شده باشد.",
  },
  {
    n: "۴",
    t: "قبول شوید، حساب می‌گیرید",
    d: "یک حساب واقعی نزد بروکر همکار، یا پرداخت کریپتویی بر اساس عملکردتان، نه یک عدد روی صفحه.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-5 max-w-2xl leading-8 text-muted">
        ...
        می‌دهد. ما همان ایده را آورده‌ایم به پیش‌بینی: ثابت کن پیش‌بینی‌هایتان
      ...
      <p className="mx-auto mt-4 max-w-2xl text-xs leading-7 text-muted">
        ...
        بی‌معنی است. برای همین سود شما باید در چند روز پخش شده باشد.
      </p>
