...
const REASONS = [
  {
    icon: "🇮🇷",
    title: "بازار ایران",
    body: "روی رویدادهای واقعی ایران پیش‌بینی کنید: اقتصاد، ورزش، اجتماعی. بازارها را خود کاربران می‌سازند.",
  },
  {
    icon: "👛",
    title: "کیف پول شخصی",
    body: "واریز و برداشت تتر، بدون واسطه. نتیجه‌ی هر پیش‌بینی همان‌جا تسویه می‌شود.",
  },
  {
    icon: "🎯",
    title: "کارنامه‌ی شفاف",
    body: "دقت پیش‌بینی، سود و زیان و جایگاه رتبه‌ی شما همیشه جلوی چشم شماست.",
  },
  {
    icon: "🏆",
    title: "چالش و لیدربورد",
    body: "امتیاز فقط از مهارت می‌آید. با MOON می‌توانید در چالش پراپ شرکت کنید.",
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="order-2 border-t border-line p-6 md:p-8 lg:order-1 lg:border-t-0">
          ...
          <p className="mt-6 border-t border-line pt-4 text-[10px] leading-6 text-muted">
            امتیاز نارمون خریدنی نیست و فقط از دقت پیش‌بینی‌هایتان ساخته می‌شود.
          </p>
        </div>
      </div>
    </div>
