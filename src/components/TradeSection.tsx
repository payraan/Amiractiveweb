...
const POINTS = [
  "می‌بینید جمع چه فکر می‌کند: کنار هر سؤال یک عدد هست. «۶۸٪ بله» یعنی از میان همه‌ی کسانی که پیش‌بینی کرده‌اند، جمع روی «بله» سنگین‌تر است.",
  "نمودار نشان می‌دهد نظر جمع در طول زمان چطور عوض شده: دیروز ۵۸٪ بود، امروز ۷۱٪. همین تغییر، خودش خبر است.",
  "قبل از ثبت می‌بینید چقدر می‌برید و چقدر می‌بازید. هرچه گزینه‌ات کم‌طرفدارتر باشد، برد بیشتری دارد.",
      ...
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 max-w-xl leading-8 text-muted">
            یک سؤال ساده می‌بینید: «بیت‌کوین تا آخر هفته بالای ۷۰ هزار دلار
            می‌بندد؟» تو بله یا خیر را انتخاب می‌کنید. اگر درست بگویید امتیاز
            می‌گیرید، و هرچه نظر شما خلاف جمع بوده و درست دربیاید، امتیاز بیشتری
            می‌گیرید.
          </p>

          <p className="mt-3 max-w-xl text-xs leading-7 text-muted">
            <b className="text-cream">چرا این‌طوری؟</b> چون حدس‌زدنِ چیزی که
            همه می‌دانند هنری نیست. اینجا فقط وقتی امتیاز می‌گیرید که بهتر از
            جمع فهمیده باشید. بازارها و درصدها زنده از پالی‌مارکت، بزرگ‌ترین
