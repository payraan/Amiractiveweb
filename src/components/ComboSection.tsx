      ...
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
        ...
        <div className="order-1 lg:order-1">
          ...
          <p className="mt-4 max-w-xl leading-8 text-muted">
            چند پیش‌بینی را در یک تیکت واحد ترکیب کنید. تیکت شما تنها زمانی
            موفق است که تمامی انتخاب‌هایتان درست باشند؛ ریسک بالاتر، اما پاداش
            چند برابری!
          </p>

          <ul className="mt-6 flex flex-col gap-3">
            {[
              "بین ۲ تا ۵ رویداد مختلف را در یک تیکت قرار دهید.",
              "با ضرب شدنِ درصد شانس هر انتخاب، پاداش نهایی به صورت تصاعدی افزایش می‌یابد.",
              "هر روز یک فرصت رایگان برای ساخت کمبو دارید؛ کمبوهای بعدی با MOON.",
            ].map((t, i) => (
