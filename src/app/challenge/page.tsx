...
const STEPS = [
  {
    ...
    d: "ثبت‌نام رایگان است و ۱۰ MOON هدیه می‌گیری. MOON بیشتر را می‌توانی بخری، یا از پاداش عضویت گروه و دعوت دوستان و فعالیت در بازارها به دست بیاوری.",
  },
  {
    n: "۲",
    t: "چالش را انتخاب و شروع کن",
    d: "ورودی چالش از MOONت کسر می‌شود. از همان لحظه ۳۰ روز وقت داری و قوانین همان لحظه قفل می‌شوند و وسط راه عوض نمی‌شوند.",
  },
  {
    n: "۳",
    t: "در ترید پیش‌بینی ثبت کن",
    d: "پیش‌بینی‌هایت را از پنل ترید ثبت می‌کنی. لازم نیست جای جدیدی بروی؛ همان بازارهایی که همیشه بازی می‌کنی، حالا در ارزیابی چالش هم حساب می‌شوند.",
  },
  {
    n: "۴",
...
const RULES = [
  ...
  },
  {
    ...
    d: "اگر از بالاترین امتیازی که رسیده‌ای ۱۵۰ پوینت پایین بیایی، چالش تمام می‌شود. این همان چیزی است که مدیریت ریسک را می‌سنجد.",
  },
  {
        ...
        <section className="px-6 pb-8">
          ...
          <div className="mx-auto mt-10 max-w-4xl text-center">
            <p className="text-[12px] leading-7 text-muted">
              پیش‌بینی‌های چالش را از پنل ترید ثبت می‌کنی.
            </p>
            <Link
              href="/trade"
