...
export const metadata: Metadata = {
  ...
  description:
    "قیمت فردای بیت‌کوین و طلا را پیش‌بینی کنید، بر اساس دقت امتیاز بگیرید و در لیدربورد امیراکتیو بالا بروید. ورود رایگان است.",
};
...
const RULES_TEXT = [
  ...
  "چهار تایم‌فریم دارید: ۲۴ ساعته (رایگان، تا ۲ بار در روز)، و ۱۲، ۴ و ۱ ساعته که با MOON باز می‌شوند. تایم‌فریم ۱ ساعته روزی یک بار.",
  ...
  "MOON با تتر (USDT) و به‌صورت آنی از کیف پول سایت خریداری می‌شود و تنها قابلیت‌ها را باز می‌کند (تایم‌فریم کوتاه‌تر و پیش‌بینی بیشتر)، نه رتبه و نه جایزه.",
    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-32">
        ...
        <p className="mt-4 max-w-xl leading-8 text-muted">
          ...
          حدس خودتان را ثبت کن؛ فردا همان ساعت، قیمت واقعی ثبت می‌شود و
