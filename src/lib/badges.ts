...
export const BADGES: BadgeDef[] = [
  ...
  // ── بازار ایران ──
  {
    ...
    icon: "🏆",
    label: "اولین برد",
    desc: "یک پیش‌بینی صحیح در بازار ایران",
    tier: "bronze",
    earned: (s) => s.irWon >= 1,
  },
  {
  ...
  },
  {
    ...
    icon: "🐋",
    label: "نهنگ",
    desc: "بیش از ۱۰۰۰ تتر حجم پیش‌بینی",
    tier: "gold",
  ...
  },
  {
    ...
    icon: "⚡",
    label: "دست داغ",
    desc: "۱۰ پیش‌بینی موفق در بازار ایران",
    tier: "gold",
    earned: (s) => s.irWon >= 10,
